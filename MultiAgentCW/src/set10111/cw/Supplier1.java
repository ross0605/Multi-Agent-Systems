...
public class Supplier1 extends Agent {
	...
	protected void setup() {
		...
		screen5.setScreenSize(5);
		stockList.put(5, 100);

		Screen screen7 = new Screen();
		screen7.setScreenSize(7);
		stockList.put(7, 100);
		...
		Battery battery2000 = new Battery();
		battery2000.setBatterySize(2000);
		stockList.put(2000, 70);

		Battery battery3000 = new Battery();
		battery3000.setBatterySize(3000);
		stockList.put(3000, 100);
